const CONTENT = {
  ...
  // Lista zdjęć wczytywana dynamicznie z portfolio/biznesowe/manifest.json (patrz niżej).
  // Aby dodać/usunąć zdjęcie: wrzuć/usuń plik w portfolio/biznesowe/ i uruchom
...
fetch('portfolio/biznesowe/manifest.json')
  .then(r => r.json())
